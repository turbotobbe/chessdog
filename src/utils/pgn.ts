...
import { squareIds, SquareId } from "@/types/chess";
...
export function parseMove(chessGameState: ChessGameState, move: string): { sourceSquareId: string, targetSquareId: string, promotionPieceName: string | null } {
    ...
    if (match) {
        ...
        if (fromFile && fromRank) {
            ...
            return { sourceSquareId, targetSquareId, promotionPieceName: promotion ? promotion : null };
        }
        ...
        if (possibleSourceSquareIds.length === 1) {
            return { sourceSquareId: possibleSourceSquareIds[0], targetSquareId, promotionPieceName: promotion ? promotion : null };
            ...
            if (disambiguatedSquare) {
                return { sourceSquareId: disambiguatedSquare, targetSquareId, promotionPieceName: promotion ? promotion : null };
            }
        }
    }
